...
@router.post("/generate-story-and-frames", response_model=StoryAndFramesResponse)
...
@router.post("/generate-story-and-frames-v1")
...
@router.post("/generate-story-and-frames-v2")
